...
contract SimpleBank {
    ...
    function enroll() public returns (bool) {
        ...
        enrolled[msg.sender] = true; // only time writing, so multiple msg.sender doesn't waste gas
    ...
    function deposit() public payable returns (uint256) {
      //NTS "msg.value" and "callvalue()" can only be used in payable public functions
